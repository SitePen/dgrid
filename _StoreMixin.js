...
function(kernel, declare, lang, Deferred, listen, aspect, put){
	...
	return declare(null, {
		...
		_onEmptyRender: function () {
			// summary:
			//		Protected method called whenever the grid is rendered with an empty
			//		results sets. Overrides the implementation in List.js in order to
			//		prevent observers from being canceled. This allows empty stores to
