	...
	return declare(null, {
		...
		renderHeader: function(){
			...
			if(!hiderMenuNode){ // first run
				...
				// On some Mac browsers, there is no scrollbar, which leaves no area for the
				// ColumnHider toggle button
				// TODO: This is duplcated from dgrid/List, it would be nice if this were in
				// a has() test
				...
				if(!scrollbarWidth){
					this.headerScrollNode.className += ' dgrid-noscrollbar';
				}
